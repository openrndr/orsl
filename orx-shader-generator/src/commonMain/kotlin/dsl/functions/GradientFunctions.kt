...
fun ShaderBuilder.gradient(
    ...
    return Functions.FunctionPropertyProvider(this@gradient, "float", "float") {
        val dx by eps
...
fun ShaderBuilder.gradient(
    ...
    return Functions.FunctionPropertyProvider(this@gradient, "vec2", "vec2") {
...
fun ShaderBuilder.gradient(
    ...
    return Functions.FunctionPropertyProvider(this@gradient, "vec3", "vec3") {
...
fun ShaderBuilder.gradient(
    ...
    return Functions.FunctionPropertyProvider(this@gradient, "vec4", "vec4") {
...
fun ShaderBuilder.jacobian(
    ...
    return Functions.FunctionPropertyProvider(this@jacobian, "vec3", "mat3") {
        val dx by Vector3(eps, 0.0, 0.0)
        val dy by Vector3(0.0, eps, 0.0)
        val dz by Vector3(0.0, 0.0, eps)
...
fun ShaderBuilder.jacobian(
    ...
    return Functions.FunctionPropertyProvider(this@jacobian, "vec4", "mat4") {
        val dx by Vector4(eps, 0.0, 0.0, 0.0)
        val dy by Vector4(0.0, eps, 0.0, 0.0)
        val dz by Vector4(0.0, 0.0, eps, 0.0)
        val dw by Vector4(0.0, 0.0, 0.0, eps)
