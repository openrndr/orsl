        ...
        program {
            ...
            val splat = computeStyle {
                ...
                computeTransform {
                    ...
                    var p by variable(hash_v3() * 2.0 - Vector3.ONE.symbol)
                    val dir by (hash_v3() * 2.0 - Vector3.ONE.symbol).normalized
